...
public class Bridge2DeckClassification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bridge2_deck_classification);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_bridge2_deck_classification, menu);
        return true;
    }
    ...
    public void classify(){
        ...
        if(val_deckClass <= 0){
            ...
            Intent i = new Intent(getBaseContext(), Bridge2Final.class);
            i.putExtra("t1", t1);
            i.putExtra("t2", t2);
            i.putExtra("w1", w1);
            i.putExtra("w2", w2);
